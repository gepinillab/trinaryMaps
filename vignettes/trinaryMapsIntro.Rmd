...
2. Make trinary map based on these bounds
3. Calculate range sizes associated with generated trinary map
4. Plot the ROC curve with upper and lower threshold bounds
